        ...
        <div className={"flex flex-col gap-6"}>
          <div className="bg-slate-800 border border-slate-700 rounded-lg p-5">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold text-slate-300 align-middle">
                Round {currentRoundData.number} <span className={`text-3xl ${getSymbol.index % 2 === 0 ? 'text-red' : "text-black"}`}>{getSymbol.char}</span> {}
              </h2>
